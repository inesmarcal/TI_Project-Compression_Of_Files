...
public class MyDescomp {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            decompress();
            System.out.println("Decompression complete! Check file " + getFileNameWOExtn[0]+"LZW." + extension);
    ...
    public static void decompress() throws IOException {
        ...
        String[] getFileNameWOExtn = filename.split("\\.");
        RandomAccessFile outputFile = new RandomAccessFile(getFileNameWOExtn[0]+"LZWD.".concat(extension), "rw");
